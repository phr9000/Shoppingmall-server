...
import styles from "../assets/styles/layout/footer.module.scss"; // eslint-disable-line no-unused-vars
  ...
  return (
    <div className={styles.footer}>
      ...
      <div className={styles.footer__info}>
        <div className={styles.footer__info__company}>
        ...
        <div className={styles.footer__info__customer}>
          <b>소비자피해보상보험</b>
          <br />
