...
const SaleLayout: React.FC = () => {
  ...
  const DiscountClick = () => {
    if (isDiscount) setDiscount(false);
  ...
  return (
    ...
    >
      ...
      <div className="hot-tag-container" style={{ marginTop: "50px" }}>
        <div className="hot-tag-area">
          ...
          <ul style={{ listStyle: "none" }} className="contents">
            ...
            {taglist
              .filter((value) => value !== "스웨트셔츠" && value !== "블라우스")
              .map((value) => (
                <li
        ...
        <div
          ...
          style={{ borderBottom: "1px solid black", marginRight: "50px" }}
        >
      ...
      >
        ...
        >
          <div
            style={{ width: "300px", height: "155px", backgroundColor: "gray" }}
          >
