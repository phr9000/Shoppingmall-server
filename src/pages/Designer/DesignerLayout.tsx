...
const DesignerLayout: React.FC = () => {
  ...
  const designerTabList = ["ALL", "WOMEN", "MEN", "LIFE", "BEAUTY"];
  const designerTabRight = ["NEW BRAND", "TOP BRAND", "EXCLUSIVE"];
      ...
      <section className="thumbnail-container">
        ...
        {visible && (
          <div className="designer-section designer-section__login--open">
            <p>
              로그인 하시면 MY🤍에 등록한 BRAND의 소식을 확인할 수 있습니다.
            </p>
            <button>로그인</button>
          </div>
        )}
